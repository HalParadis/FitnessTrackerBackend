...
describe("/api/activities", () => {
  ...
  describe("POST /api/activities (*)", () => {
    ...
    ("responds with an error when a activity already exists with the same name", async () => {
  ...
  describe("PATCH /api/activities/:activityId (*)", () => {
    ("Anyone can update an activity (yes, this could lead to long term problems a la wikipedia)", async () => {
    ...
    ("returns an error when updating an activity that does not exist", async () => {
    ...
    ("returns an error when changing an activity to have the name of an existing activity", async () => {
  ...
  describe("GET /api/activities/:activityId/routines", () => {
    ("Get a list of all public routines which feature that activity", async () => {
    ...
    ("Should return an error when you ask for an activity that does not exist", async () => {
